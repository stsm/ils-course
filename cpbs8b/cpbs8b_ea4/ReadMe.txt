========================================================================
    ANWENDUNG: cpbs8b_ea4-Projektübersicht
========================================================================

Diese cpbs8b_ea4-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre cpbs8b_ea4-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "cpbs8b_ea4.pch und eine 

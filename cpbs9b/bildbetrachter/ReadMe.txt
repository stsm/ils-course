========================================================================
    ANWENDUNG: Bildbetrachter-Projektübersicht
========================================================================

Diese Bildbetrachter-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre Bildbetrachter-Anwendung besteht.

Bildbetrachter.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Bildbetrachter.pch und eine 

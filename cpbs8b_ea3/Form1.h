...
#pragma endregion
	...
	private: System::Void btn_Berechnen_Click(System::Object^  sender, System::EventArgs^  e) {
				 Single sinZahl1, sinZahl2, sinErgebnis = 0;
				 Boolean boolDivNull = false;
				 ...
				 switch (cmbBox_Rechenoperationen->SelectedIndex)
				 {
					...
					case 3: // Division
						 ...
						 break;
					default:
					 MessageBox::Show("Da ist leider etwas flasch gelaufen.","Oops!");
				 }
				 if (boolDivNull == true){
					 lbl_ErgebnisAnzeige->Text = "Nicht definiert!";
				 }
				 else{

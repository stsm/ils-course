========================================================================
    ANWENDUNG: webbrowser-Projektübersicht
========================================================================

Diese webbrowser-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre webbrowser-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "webbrowser.pch und eine 
